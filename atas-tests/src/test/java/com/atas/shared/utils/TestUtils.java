...
/**
 * Shared utility class for test operations.
 * Contains common methods used across different feature tests.
 */
@Slf4j
public class TestUtils {
     ...
     */
    public static TestResult createTestResult(TestExecution execution, String testId, String testName, TestStatus status) {
     ...
     * Use sparingly and prefer explicit waits in UI tests.
     */
    ...
    public static void logTestExecution(TestExecution execution) {
        log.info("Test Execution: ID={}, Suite={}, Status={}, Environment={}", 
    ...
    public static void logTestResult(TestResult result) {
        log.info("Test Result: ID={}, Name={}, Status={}", 
                result.getTestId(), 
                result.getTestName(), 
                result.getStatus());
    }
