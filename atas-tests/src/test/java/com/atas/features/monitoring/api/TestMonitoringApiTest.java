...
/**
 * API tests for the monitoring endpoints. These tests run against a random port Spring Boot
 * instance and use RestTemplate to call REST endpoints. They verify that the status endpoint
 * aggregates results correctly and returns the expected fields.
 */
@SpringBootTest(
...
@Slf4j
public class TestMonitoringApiTest {
