...
/**
 * Configuration class for monitoring feature tests.
 * Provides REST client configurations and test settings.
 */
@Configuration
@Slf4j
public class MonitoringTestConfig {
    ...
    /**
     * REST template for monitoring API tests.
    ...
    /**
     * Base URL configuration for monitoring endpoints.
     * This would typically be externalized to application properties.
     */
