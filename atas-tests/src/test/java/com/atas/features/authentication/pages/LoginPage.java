 ...
 * to enter credentials and submit the form.  Demonstrates method
 * chaining for clear and concise test code.
 */
public class LoginPage extends BasePage<LoginPage> {
    ...
    public LoginPage navigate() {
        ...
        String testLoginUrl = getClass().getClassLoader().getResource("test-login.html").toExternalForm();
    ...
    /**
     * Click the login button.  Returns a new {@link DashboardPage}
     * representing the next page in the workflow.
     */
