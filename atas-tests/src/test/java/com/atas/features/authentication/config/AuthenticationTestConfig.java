...
/**
 * Configuration class for authentication feature tests.
 * Provides common driver configurations and test settings.
 */
@Configuration
@Slf4j
public class AuthenticationTestConfig {
    ...
    /**
     * Default driver configuration for authentication UI tests.
     * Optimized for login/dashboard testing scenarios.
     */
