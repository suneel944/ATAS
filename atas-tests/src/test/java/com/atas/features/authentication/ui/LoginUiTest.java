...
/**
 * Example UI test demonstrating how to use the ATAS framework. It leverages Spring Boot's test
 * support to wire up services and persists results and recordings to the database. This test
...
public class LoginUiTest {
  ...
  @Autowired private VideoRecordingService videoRecordingService;
  ...
  void loginWithInvalidCredentialsShouldNotLoadDashboard() {
    ...
    loginPage.navigate().enterUsername("invalid@user.com").enterPassword("wrongpass");
