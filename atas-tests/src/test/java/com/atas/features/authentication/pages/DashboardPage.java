 ...
 * login.  Provides verification methods to assert that the page
 * loaded correctly.
 */
public class DashboardPage extends BasePage<DashboardPage> {
    ...
    /**
     * Verify that the dashboard is loaded by checking the page title.
     * Returns this instance for further assertions.
     */
