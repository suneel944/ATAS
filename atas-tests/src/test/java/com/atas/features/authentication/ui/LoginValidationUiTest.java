...
/**
 * UI tests for login validation scenarios.
 * Tests various input validation and error handling cases.
 */
...
class LoginValidationUiTest {
    ...
    @BeforeEach
    void initTest() {
        DriverConfig driverConfig = DriverConfig.builder()
                .headless(true)
                .recordVideo(false)
    ...
    void loginWithEmptyCredentialsShouldShowValidationError() {
        ...
        TestResult result = TestUtils.createTestResult(
                execution, 
