...
/**
 * Implementation of {@link StorageService} backed by Amazon S3.  This
 * service uploads files to the configured bucket and returns a
 * presigned URL valid for a limited duration.  The default AWS
