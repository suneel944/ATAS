...
/**
 * Abstraction for uploading files to external storage. Implementations could upload videos and
 * screenshots to Amazon S3 or another provider. The returned URL should be publicly accessible or
