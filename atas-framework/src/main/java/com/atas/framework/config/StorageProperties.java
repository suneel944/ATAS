...
/**
 * Configuration properties for external storage such as Amazon S3. Values can be supplied via
 * application.yml or environment variables. The {@code prefix} attribute defines the root in
