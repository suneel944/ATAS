...
public class TestExecutionController {
  ...
  public ResponseEntity<TestExecutionResponse> executeCustomTests(
  ...
  public ResponseEntity<List<TestDiscoveryResponse.TestClassInfo>> getTestClassesByType(
      @PathVariable String type) {
    log.info("Getting test classes by type: {}", type);

    List<TestDiscoveryResponse.TestClassInfo> testClasses =
        testExecutionService.getTestClasses().stream()
  ...
  public ResponseEntity<List<TestDiscoveryResponse.TestSuiteInfo>> getTestSuitesByType(
      @PathVariable String type) {
    log.info("Getting test suites by type: {}", type);

    List<TestDiscoveryResponse.TestSuiteInfo> testSuites =
        testExecutionService.getTestSuites().stream()
