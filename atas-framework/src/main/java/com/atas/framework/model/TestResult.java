...
/**
 * Entity representing the outcome of a single test.  Each result
 * belongs to a {@link TestExecution} and contains child steps,
 * attachments and metrics.  The testId is typically the fully
 * qualified method name or a custom identifier provided by the
 * caller.
 */
@Entity
