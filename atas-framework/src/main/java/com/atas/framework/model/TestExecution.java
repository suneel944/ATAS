...
/**
 * Entity representing a single execution of a test suite.  Each
 * execution aggregates a number of {@link TestResult} records and
 * stores metadata such as environment and video recording.  The
 * execution identifier is used to correlate results across
 * services and may be exposed externally via the API.
 */
@Entity
...
public class TestExecution {
    ...
    /** Test results belonging to this execution.  Cascade on persist to
     * ensure results are stored automatically when execution is saved. */
