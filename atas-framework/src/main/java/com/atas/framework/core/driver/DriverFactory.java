...
/**
 * Factory API for creating Playwright page instances. Implementations are responsible for launching
 * browsers, creating isolated contexts and pages and ensuring proper cleanup after use. The factory
 * abstracts away driver configuration details from the callers.
 */
public interface DriverFactory {

  /**
   * Create a new {@link Page} for the given browser type and configuration. Implementations must
   * guarantee that pages are isolated from each other (e.g. using separate browser contexts).
   *
   ...
   * shutting down to ensure there are no leaking processes.
   */
  void closeAll();
}
